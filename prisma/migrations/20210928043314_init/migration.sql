-- CreateEnum
CREATE TYPE "Error" AS ENUM ('EMAIL_ALREADY_USED', 'EMAIL_REGUIRED', 'INTERNAL_SERVER_ERROR', 'INVALID_PASSWORD', 'NOT_ADMIN', 'NOT_AUTHORIZED', 'NOT_VALID_EMAIL', 'PASSWORD_REGUIRED', 'USER_NOT_FOUND');
